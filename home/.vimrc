...
"https://www.youtube.com/watch?v=RGOsE3UWqhI  // intersante plugins
"https://github.com/VundleVim/Vundle.vim // kann ich nicht zum laufen bringen
"https://github.com/vifm/vifm.vim // benotigt Vundle
"
"
"
"
...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" zc, zo
"set foldmethod=indent //interfiere with autocomplete
set nofoldenable
...
" Enable syntax highlighting If you want Vim to overrule your settings with the defaults, use:
""syntax on
...
" build tags for own projects with Ctrl-t
map! <C-t> :!ctags -R --sort=yes --c++-kinds=+p --fields=+iaS --extra=+q .<CR>
